...
namespace LinqAndLambda
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var itemQuery2 = items.Where(FilterItems).OrderBy(OrderItemsByName);
        ...
        //Used for method 2
        private bool FilterItems(Item i) => i.ItemName.Contains("o");
        private string OrderItemsByName(Item i) => i.ItemName;
    }
}